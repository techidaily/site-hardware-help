...
date: 2024-08-28 18:30:50
updated: 2024-08-29 12:16:22
tags:
  - hardware
categories:
  - tech
...
## Rising Against the Competition: In-Depth Analysis of the ROG Ally X Mid-Generation Update and Our Expectations for What's Next
...
ASUS
 ...
 Performance improvements due to faster memory should be minimal (the ROG Ally packs 16GB of [LPDDR5](https://smart-video-creator.techidaily.com/updated-in-2024-make-videos-in-minutes-wevideo-online-editor/)\-6400 RAM); I don't expect more than 10% difference between the two machines.

 We should also get support for regular-sized 2280 [NVMe SSDs](https://digital-screen-recording.techidaily.com/new-2024-approved-audio-capture-for-post-review/) instead of being limited to compact 2230 SSDs on the OG Ally. This should allow for more affordable storage upgrades, but considering that the ROG Ally X features 1TB of storage and a working SD card reader, I doubt many owners will opt to upgrade the SSD.
...
##  Extra Improvements I'd Love to See in the ROG Ally X
 ...
 According to Videocardz and their sources, this ought to be the case. The ROG Ally X will reportedly ditch the XG Mobile port and replace it with a [USB 4](https://bypass-frp.techidaily.com/how-to-bypass-frp-from-google-pixel-8-pro-by-drfone-android/) Type-C port. Better yet, the USB 4 port is accompanied by the second USB-C 3.2 10Gbps port.
...
Goran Damnjanovic / How-To Geek
 ...
 I’d also like to see tighter thumbsticks. The ones of the OG Ally are a bit loose and a pair of tighter thumbsticks would be a nice improvement. According to [The Verge’s Sean Hollister](https://www.theverge.com/2024/5/16/24157533/asus-rog-ally-x-prototype-hands-on), this is the case, which is welcome news. The face buttons on the Ally X are also (reportedly) less prone to rattling, which is another pet peeve I have with my Ally that’s now fixed on the X.
...
###  An APU That’s Designed for a Gaming Handheld
 ...
 One that will make the iGPU the main part of the equation and that won’t pack an ultra-overkill 8-core CPU. A 6-core CPU should be more than enough, as should a wider memory bus that would help the GPU spread its wings, [something we might see](https://instagram-video-files.techidaily.com/instagram-filters-for-the-win-maximize-likes-and-comments-effortlessly/) in the next generation of AMD APUs.
