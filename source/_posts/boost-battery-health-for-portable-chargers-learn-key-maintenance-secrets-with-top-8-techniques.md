...
## Boost Battery Health for Portable Chargers: Learn Key Maintenance Secrets with Top 8 Techniques
...
_Asus_
 ...
 When you plug a device into a power bank that's charging itself, you're asking it to do two energy-intensive things at once—charge itself and power your device. [This is known as pass-through charging](https://vp-tips.techidaily.com/new-2024-approved-edit-masters-seamless-text-insertion-for-photos/). This double duty can cause extra heat buildup in the power bank's lithium-ion battery, and this extra thermal stress can degrade the battery cells faster over time.

 Splitting its power between two tasks also means the power bank may charge slower, and your connected device may not even get the full power it needs. Yes, some models from brands like the [Ugreen 20000mAh](https://fox-that.techidaily.com/1721452377806-issues-with-your-iphones-location-heres-how-you-can-fix-them/) and Zendure handle pass-through charging better than others, but it's generally best to avoid it if you can. Let the power bank fully charge itself first before using it to top up your gadgets.
