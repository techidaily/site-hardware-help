...
date: 2024-08-26 18:40:57
updated: 2024-08-29 10:17:37
tags:
  - android
categories:
  - tech
...
* [Testing the Hardware](https://youtube-data.techidaily.com/ising-above-internet-naysayers-and-detractors-for-2024/)
* [Test the Buttons and Vibration Motor](https://extra-resources.techidaily.com/new-action-in-high-definition-t5-eye-revealed/)
* [Test the Screen](https://apple-account.techidaily.com/in-2024-how-to-fix-locked-apple-id-on-iphone-15-pro-max-by-drfone-ios/)
* [Simulate a Fake Call](https://ai-vdieo-software.techidaily.com/fcpx-mastery-40-essential-keyboard-shortcuts-to-improve-your-skills/)
...
* Use secret Android codes to test used phones before buying to avoid hidden hardware issues.
* Third-party apps might not cover all hardware aspects like Android's built-in diagnostic tools.
* Check IMEI, buttons, screen, ports, sensors, and battery health.
...
Close 
 ...
 The very first thing you want to check is the hardware tags. Look for the [IMEI number](https://some-approaches.techidaily.com/updated-leading-picks-unlimited-photo-sharing-platforms/). Every phone has a unique identifying number called the IMEI number, which makes it easy to blacklist lost or stolen phones. Phones with blacklisted IMEI numbers become unusable.

 Tap “Check Version Info” to reveal the phone’s IMEI number (dual-SIM phones have two IMEI numbers). Note the number and enter it into an IMEI testing tool such as [Swappa](https://swappa.com/imei)or [Imeipro.info](https://www.imeipro.info/). If the IMEI is clean, tap the “Pass” button and move on to the next check.
...
![Vibration motor test menu item in the Android CIT tools.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/05/vib-1.jpg) 
...
##  Test the Screen
 ...
 The diagnostics app should automatically take you to the Backlight Test after the last step. Here, you can test the minimum and maximum brightness of the display. Turn the flashlight on and off too.
...
Close 
 ...
 Now go back to the main menu and tap “Charger Test.” Plug in a charger and take note of the reading. A functional charging port should output close to or more than 1 Ampere.

![Highlighted menu item for launching the charging port test on Android.](https://static1.howtogeekimages.com/wordpress/wp-content/uploads/2024/05/charger.png) 
...
Close 
 ...
 Look for the reading in front of the MB\_06 tag, which indicates battery health. It’ll read “Good," “Excellent," or “Poor." [Poor battery health](https://some-approaches.techidaily.com/in-2024-the-evolution-of-live-streaming-with-periscope/) means that the phone’s battery is at the end of its life cycle and needs replacing.
