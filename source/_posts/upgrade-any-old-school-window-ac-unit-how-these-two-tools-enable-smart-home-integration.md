...
date: 2024-08-26 20:17:44
updated: 2024-08-29 12:30:37
tags:
  - hardware
categories:
  - tech
...
## Upgrade Any Old-School Window A/C Unit: How These Two Tools Enable Smart Home Integration

### Quick Links

* [A Handy Dandy Smart Plug](https://facebook-record-videos.techidaily.com/new-in-2024-brightening-filmmaking-ranking-the-17-best-lights/)
* [A Wi-Fi Temperature Sensor (or Thermostat)](https://www.howtogeek.com/these-two-gadgets-make-an-old-window-air-conditioner-smart/#a-wi-fi-temperature-sensor-or-thermostat)
...
##  A Handy Dandy Smart Plug
 ...
 The solution I found was the [Kasa Outdoor Smart Plug for $16](https://www.amazon.com/dp/B099KLNM24?th=1&tag=hotoge-20&ascsubtag=UUhtgUeUpU2004235&asc%5Frefurl=https%3A%2F%2Fwww.howtogeek.com%2Fthese-two-gadgets-make-an-old-window-air-conditioner-smart%2F&asc%5Fcampaign=Evergreen). As the name implies, it's meant for outdoors, but you can obviously use it indoors as well. So far, I've been able to run my window AC on its highest settings without tripping the smart plug.

 Before you buy a smart plug, there's one thing you need to check. Make sure your window AC unit has analog controls. This is important because the smart plug simply turns power on or off. So, the AC needs to be able to start from its last state when plugged in without any manual initiation.
...
##  A Wi-Fi Temperature Sensor (or Thermostat)
 ...
 The idea here is to automatically turn on the AC when a certain temperature is reached—and maybe even turn it off at a specific temperature as well. You can achieve this with a wireless temperature sensor, such as the [$39 Govee Wi-Fi Thermometer](https://www.amazon.com/Govee-Indoor-Temperature-Humidity-Sensor/dp/B0872ZWV8X/?tag=hotoge-20&ascsubtag=UUhtgUeUpU2004235&asc%5Frefurl=https%3A%2F%2Fwww.howtogeek.com%2Fthese-two-gadgets-make-an-old-window-air-conditioner-smart%2F&asc%5Fcampaign=Evergreen). Put the sensor in the same room as the AC and you have a simple way to track the temperature.

 If you already have a smart thermostat in your home, that can act as your temperature sensor. Or you can go a different route, like me. I have an [ecobee Smart Thermostat](https://amazon.com/dp/B09XXTQPXC?tag=hotoge-20&ascsubtag=UUhtgUeUpU2004235&asc%5Frefurl=https%3A%2F%2Fwww.howtogeek.com%2Fthese-two-gadgets-make-an-old-window-air-conditioner-smart%2F&asc%5Fcampaign=Evergreen), and with the SmartThings app, I can use the device state as a trigger for automation. That means when my whole home central AC kicks on, I can tell the window AC unit to run for 10 minutes to give my bedroom a nice boost.
...
Close 
 ...
 I have it set up to turn off the AC after 10 minutes automatically, but you could just as easily create a second routine that turns off the AC when a certain temperature is reached. In both cases, you're saving energy by not running the AC all day or night.

---

 Smart home tech isn't always about buying the shiny, new Wi-Fi-enabled gadgets. Sometimes, it's adding basic smarts to your existing devices, and that may be even more useful in your daily life.
