---
title: "Beyond Coding: Daily Life Applications of Keyboard Macros"
date: 2024-08-30T15:42:02.234Z
updated: 2024-08-31T15:42:02.234Z
tags:
  - hardware
categories:
  - tech
...
## Beyond Coding: Daily Life Applications of Keyboard Macros
...
##  What Can You Macro?
 ...
 There are so many mundane, repetitive things that we do on our computers every day that can be made simpler and faster by turning them into a macro. For me, I have [a keyboard](https://dygma.com/) that supports multiple layers and allows me to create macros within its own software. For you, you might need third-party programs like [AutoHotKey](https://www.autohotkey.com/)on Windows or [HammerSpoon](https://www.hammerspoon.org/)for macOS. Or, you could opt instead for something like Elgato’s Stream Deck, which is a dedicated macro keypad that has mini LCD’s which can be set to show different images to help you remember what each button does.

 We [reviewed the Stream Deck+](https://screen-activity-recording.techidaily.com/2024-approved-the-screen-recorders-journey-a-deep-dive-into-the-best-tools/), if you need inspiration as to how to expand your desk setup further.
