---
title: Inside Look at Samsung's New Copilot+ Notebook - Best Value in the Market for Windows PCs!
date: 2024-11-04T20:05:24.667Z
updated: 2024-11-05T18:54:38.555Z
tags:
  - laptops
categories:
  - tech
thumbnail: https://www.zdnet.com/a/img/resize/a48567cb2b71c5af2757c8c1b3701fdf69ee15c0/2024/03/28/166e7f46-2a73-4be3-a173-f6f1caedadc1/dsc00109.jpg?auto=webp&fit=crop&frame=1&height=172&width=306
---

## Samsung's New Copilot+ PC Shines as a Must-Have Deal for Windows Users – In-Depth Analysis

![Galaxy Book4 Edge](https://www.zdnet.com/a/img/resize/8a13467d7e6634d8a4f3982469d3c32fd806a963/2024/07/02/73e853ae-79e0-4063-b8e9-4a34ac5b4a81/galaxy-book4-edge-3.jpg?auto=webp&precrop=6000,3376,x0,y0&width=1280)
...
**Also: [I tried to torture-test Panasonic's ultra-rugged Toughbook. It didn't even blink](https://www.zdnet.com/article/i-tried-to-torture-test-panasonics-ultra-rugged-toughbook-it-didnt-even-blink/)**

[ZDNET RECOMMENDS Samsung Galaxy Book 4 Edge The Galaxy Book 4 Edge has a stunning display and lightning-fast performance in an ultra-thin form factor. View at Best Buy](https://shop-links.co/link/?url=https%3A%2F%2Fwww.bestbuy.com%2Fsite%2Fsamsung-galaxy-book4-edge-copilot-pc-14-amoled-touch-screen-laptop-snapdragon-x-elite-16gb-memory-512gb-storage-sapphire-blue%2F6583789.p&publisher_slug=itechdaily19598&exclusive=1)

Of [all the new Snapdragon Copilot+ PCs released this year](https://www.zdnet.com/article/every-copilot-pc-microsoft-just-announced-to-take-on-apples-m3-macbooks/), this laptop has one of the clearest use cases. It really shines when paired with other Samsung products, particularly a [Galaxy phone](https://www.zdnet.com/article/best-samsung-phone/), which can be remotely controlled on the laptop in Samsung's Plug-in app -- something [Apple is still developing](https://www.zdnet.com/article/your-apple-macbook-is-getting-a-free-upgrade-here-are-the-best-macos-15-features/) \-- as well as a host of other features.

To make the most of the Galaxy Book 4 Edge, however, a few things have to fall into place. More on that in a bit; first let's look at the specs.
...
Earlier this year, my colleague [Kerry Wan reviewed](https://www.zdnet.com/article/samsung-galaxy-book-4-ultra-review/) this machine's predecessor -- the Galaxy Book 4 Ultra with the Intel Core Ultra 7 or 9 chip -- and was equally impressed with its OLED display. Samsung upped the ante with the AMOLED display in the Edge, which offers both better power efficiency and better resolution (but comes with an increased cost). 

**Also: [I saw the future of AI at Qualcomm's headquarters, and Copilot+ PCs were only just the beginning](https://www.zdnet.com/article/i-saw-the-future-of-ai-at-qualcomms-headquarters-and-copilot-pcs-were-only-just-the-beginning/)**

This display is also a touchscreen, but doesn't come with a stylus, nor does it fold back flat or into a tablet. However, a few useful applications of the touch include the ability to pinch-to-zoom and to scroll --two functions that are intimately familiar to all of us on our smartphones. 
...
The trackpad on the Edge, however, is nothing short of massive. Just like on the Book 4 Ultra, this thing has a football field-sized trackpad that some people will love, but for others might be more trouble than it's worth. 
...
**Review: [Samsung Galaxy Book 4 Ultra: This Windows flagship gave my MacBook Pro a run for its money](https://www.zdnet.com/article/samsung-galaxy-book-4-ultra-review/)**

In our review of the Edge's predecessor earlier this year, [we noted that the trackpad was not the laptop's strong suit](https://www.zdnet.com/article/samsung-galaxy-book-4-ultra-review/): it would oscillate between being too sensitive and not sensitive enough. Samsung seems to have optimized the technology on the Edge, as I didn't have any notable issues with its responsiveness this time around. 
...
The Galaxy Book 4 Edge doesn't just come with the new Snapdragon X Elite processor; it comes with the most powerful version of it. The 3.8GHz, 12-core processor with dual-core boost is only available in the 1TB configuration of the Edge, something of a power move by Samsung.

After benchmarking the processor in [Geekbench](https://www.geekbench.com/), I got a single-core score of 2953, and a multi-core score of 15672, an impressive number that puts the Galaxy Book 4 Edge at the top of the Copilot+ PCs, and beats some of the MacBook numbers, although Apple's Silicon still gets higher scores with single-core performance and its GPU. 

**Also: [I've tested dozens of 2-in-1 laptops. This one hits all the right marks](https://www.zdnet.com/article/ive-tested-dozens-of-2-in-1-laptops-this-one-hits-all-the-right-marks/)**

The Qualcomm Adreno GPU on board is not going to beat Apple's M3 integrated graphics head-to-head, but in tandem with the Snapdragon's NPU and lightning-fast CPU, it puts up a good fight. Video editing in DaVinci Resolve on the Galaxy Book 4 Edge was smooth, especially with AI-related tasks, and I expect performance in this area to continue to improve over time. 
...
The other big thing that sets the Galaxy Book 4 Edge apart is its use of universal flash storage (eUFS) instead of a solid-state drive (SSD). Because eUFS is the type of storage technology used in smartphones, it tracks that Samsung would bridge this technology into their laptop product line, but some caveats come with this. 

First, this laptop's storage is a solid unit that is not alterable or upgradeable in any way: It's embedded into the machine as-is. For that reason, I strongly suggest opting for the 1TB configuration if you're interested in buying the Edge, since what you choose at the time of purchase will be what you're stuck with for the rest of the laptop's life cycle. 

**Also: [I tested LG's 17-inch Gram Pro and it's the big-screen, lightweight laptop to beat](https://www.zdnet.com/article/i-tested-lgs-17-inch-gram-pro-and-its-the-big-screen-lightweight-laptop-to-beat/)**

Second, the 3.8GHz processor only comes with the 1TB configuration of the Edge. And since the 1TB version only comes as a 16-inch, this is one laptop where the gap between the 14- and 16-inch versions is so much greater than simply the screen size. 

I would only consider buying this laptop if you're ready to commit to the 16-inch, 1TB storage version. Any other configuration is too much of a step-down. In that vein, the 16-inch version goes for $1,750, which certainly is not cheap, but is still under $2,000, the cutoff for what the average consumer would consider "practical." 
...
Lastly, the battery on the Edge is indeed impressive. [I recently tested HP's Omnibook X 14](https://www.zdnet.com/article/one-of-the-best-laptops-for-work-travel-ive-tested-is-not-made-by-lenovo-or-apple/), another Copilot+ PC with the Snapdragon X Elite processor, and noted its outstanding battery performance. The Galaxy Book 4 Edge is even better, considering the massive AMOLED display and more powerful processor. 
...
<li><a href="https://fox-helps.techidaily.com/new-elevate-your-videos-explore-the-10-best-online-backdrop-changers-for-2024/"><u>[New] Elevate Your Videos Explore the 10 Best Online Backdrop Changers for 2024</u></a></li>
<li><a href="https://fox-cloud.techidaily.com/updated-digital-photo-management-incorporating-dates-seamlessly/"><u>[Updated] Digital Photo Management Incorporating Dates Seamlessly</u></a></li>
...
<li><a href="https://extra-tips.techidaily.com/revealing-clarity-mastering-the-eraser-feature-in-psx/"><u>Revealing Clarity Mastering the Eraser Feature in PSX</u></a></li>
...
<li><a href="https://blog-min.techidaily.com/ultimate-tutorial-transforming-dvd-content-into-mp4-files-via-vlc-for-pc-and-mac-users/"><u>Ultimate Tutorial: Transforming DVD Content Into MP4 Files via VLC for PC & Mac Users</u></a></li>
